...
st.caption("Compare the share of different electrolysis technologies in PtX projects in Germany from 2021 to 2024.")

st.write("PEM dominates the project landscape in every year, ranging from about one‑third to over half of all projects. ALK loses share over time, while SOEC, AEMWE and “other” electrolysis methods gradually appear as developers test more experimental options alongside the mature technologies.")

st.image("files/technologies.png", caption="Different electrolysis technologies used in PtX projects in Germany, ALK vs PEM vs SOEC. - Image generated by Google DeepMind's Nano Banana Pro model via Gemini 3 Pro (November 2025).")
...
renderedbar_chart = bar_chart.render().decode('utf-8')
st.components.v1.html(renderedbar_chart, height=520)
st.caption("Compare the share of different PtX products in projects in Germany from 2021 to 2024.") 

st.write("Across all four years, hydrogen clearly dominates the PtX product portfolio, rising from about 63% of projects in 2021 to over 83% in 2024. Synfuels and methanol appear every year but remain secondary, while methane and “no defined product yet” signal pilot and experimental projects rather than large‑scale deployment.")


st.write("## Cumulative product picture")
st.write("Cumulatively, almost four out of five PtX projects in Germany target hydrogen as their main product, with a smaller but persistent group exploring liquid e‑fuels, methanol, synthetic hydrocarbons and methane.")
...
st.caption("Compare the cumulative share of different PtX products in projects in Germany from 2021 to 2024.")

st.write("The combination of PEM dominance and a strong bias toward hydrogen output suggests that German PtX deployments are optimised first for flexible, grid‑coupled H₂ production rather than for complex downstream synthesis routes. Liquid synfuels and methanol appear mainly in smaller project numbers, often in demonstration settings or targeting specific industrial or transport niches.")
st.write("If this pattern continues, Germany’s near‑term PtX system will look like a hydrogen backbone with smaller satellites of methanol and e‑fuel projects attached to it. For sectors such as aviation or chemical feedstocks, this means that scaling synfuels will depend on how quickly these early, technology‑diverse pilot projects can be de‑risked and replicated.")
