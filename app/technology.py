...
st.image("files/technologies.png", caption="Different electrolysis technologies used in PtX projects in Germany, ALK vs PEM vs SOEC. - Image generated by Google DeepMind's Nano Banana Pro model via Gemini 3 Pro (Feb 2026).")
